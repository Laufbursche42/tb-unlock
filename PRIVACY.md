...
- Any settings you make on the page (target speed, ride mode, the encryption switch). They exist only in the open page during your session.
...
Nothing is ever sent to the developer or to any manufacturer backend. There is no cloud account and no server operated by this project that receives your data. For comparison: the original Trittbrett app signs you in and talks to a manufacturer backend. This app does none of that.
